...
| **`GET`** | `/players/export/csv` | Limit export requests |
| **`GET`** | `/players/export/json` | Limit dataset downloads |
| **`POST`** | `/players/import-json` | Limit large file uploads |
...
| **`GET`** | `/jwt/private-players` | Protect JWT secured APIs with strict limits |
