...
| **`POST`** | `/coins/import-json` | Validate uploaded JSON file |
...
| **`POST`** | `/coins/import-json` | Import dataset using JSON file |
| **`GET`** | `/coins/export/csv` | Export dataset as CSV |
| **`GET`** | `/coins/export/json` | Export dataset as JSON |
| **`GET`** | `/coins/export/excel` | Export dataset as Excel |
| **`GET`** | `/coins/export/pdf` | Export analytics report as PDF |
